...
/**
 * The iTunes half of Guess the Melody (real 30-second preview clips of film / TV /
 * game themes, generated by scripts/genmelodies_itunes.mjs into melodiesExtra.ts).
 * A SEPARATE pack because LAUNCH_PLAN D3 makes iTunes previews web only: content/index.ts
 * gates any pack carrying iTunes media to `platforms: ['web']`, while the synthesized
 * public-domain pack above ships everywhere (its WAVs live under /clips/, same origin).
 */
export const melodiesItunesPack: RawPack = {
  ...melodiesPack,
  id: 'melodies-itunes',
  name: 'Guess the Melody · Themes',
  description: 'Famous film, TV and game themes as real clips. Name the tune!',
  letters: melodiesExtra,
};
