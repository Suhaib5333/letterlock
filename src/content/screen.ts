...
export const moviesPack: RawPack = {
  ...
  letters: {
    ...
    F: [
      ...
      { q: 'NBC sitcom about six friends living in New York City, running for ten seasons from 1994 to 2004.', a: 'Friends', category: 'screen' },
      { q: 'Disney animated film about two royal sisters and a kingdom trapped in an eternal winter.', a: 'Frozen', category: 'screen' },
      { q: 'David Fincher\'s 1999 film in which a white-collar worker forms an underground fight organisation with a soap salesman.', a: 'Fight Club', category: 'screen' },
      { q: 'Coen Brothers\' 1996 dark comedy about a kidnapping scheme gone wrong in snowy Minnesota.', a: 'Fargo', category: 'screen' },
    ],
    G: [
      { q: 'Ridley Scott\'s 2000 Roman epic in which a betrayed general fights as a gladiator to avenge his family.', a: 'Gladiator', category: 'screen' },
    ...
    H: [
      ...
      { q: 'Quentin Tarantino\'s 2015 mystery Western in which eight strangers are snowbound at a remote Wyoming lodge.', a: 'Hateful Eight', category: 'screen' },
    ...
    I: [
      ...
      { q: 'Quentin Tarantino\'s 2009 WWII alternate-history film set in German-occupied France with a "Basterds" squad.', a: 'Inglourious Basterds', category: 'screen' },
    ],
    J: [
      ...
      { q: 'Spielberg\'s 1993 adventure in which genetically cloned dinosaurs escape on an island theme park.', a: 'Jurassic Park', category: 'screen' },
    ...
    L: [
      { q: 'David Lean\'s 1962 epic biopic about T. E. Lawrence, the British officer who united Arab tribes in WWI.', a: 'Lawrence of Arabia', category: 'screen' },
      { q: 'Luc Besson\'s 1994 action film in which a professional hitman mentors a young girl orphaned by corrupt DEA agents.', a: 'Leon the Professional', category: 'screen' },
    ...
    S: [
      { q: 'Steven Spielberg\'s 1993 film about Oskar Schindler, who saved over a thousand Jewish workers during the Holocaust.', a: 'Schindler\'s List', category: 'screen' },
    ...
    T: [
      ...
      { q: 'John Lasseter\'s 1995 Pixar debut about a cowboy doll threatened by a new space-ranger toy.', a: 'Toy Story', category: 'screen' },
    ...
    X: [
      ...
      { q: 'Lucy Lawless starred as this sword-wielding ancient Greek warrior princess in a popular 1990s TV series.', a: 'Xena Warrior Princess', category: 'screen' },
    ],
    Y: [
...
export const moviesHardPack: RawPack = {
  ...
  letters: {
    A: [
      ...
      { q: 'Edward Berger\'s 2022 German anti-war film, the fourth screen adaptation of Erich Maria Remarque\'s WWI novel.', a: 'All Quiet on the Western Front', category: 'screen' },
      ...
      { q: 'Andrei Tarkovsky\'s 1966 Soviet epic about the medieval Russian icon painter who witnesses war and destruction.', a: 'Andrei Rublev', category: 'screen' },
    ],
    B: [
    ...
    C: [
      ...
      { q: 'Bob Fosse\'s 1972 musical set in Weimar-era Berlin\'s cabaret world, starring Liza Minnelli as Sally Bowles.', a: 'Cabaret', category: 'screen' },
    ...
    D: [
      { q: 'Stanley Kubrick\'s 1964 dark comedy about a retired Nazi scientist who tries to prevent a nuclear catastrophe triggered by a rogue general.', a: 'Dr Strangelove', category: 'screen' },
    ...
    G: [
      { q: 'Martin Scorsese\'s 1990 crime film following Henry Hill\'s decades inside the New York mob, based on a true story.', a: 'Goodfellas', category: 'screen' },
    ],
    H: [
      { q: 'Quentin Tarantino\'s 2015 mystery Western in which eight strangers stranded in a Wyoming haberdashery by a blizzard harbour deadly secrets.', a: 'Hateful Eight', category: 'screen' },
    ],
    I: [
      { q: 'Quentin Tarantino\'s 2009 alternate-history WWII film in which a squad of Jewish-American soldiers scalp Nazi officers in France.', a: 'Inglourious Basterds', category: 'screen' },
    ],
    J: [
      { q: 'Joaquin Phoenix won the Best Actor Oscar for his transformative portrayal of the clown prince of crime in this 2019 origin film.', a: 'Joker', category: 'screen' },
    ],
    K: [
      { q: 'Quentin Tarantino\'s two-part samurai revenge epic in which Uma Thurman\'s assassin works through a death list.', a: 'Kill Bill', category: 'screen' },
      { q: 'Rian Johnson\'s 2019 whodunit starring Daniel Craig as the drawling detective Benoit Blanc investigating a crime novelist\'s death.', a: 'Knives Out', category: 'screen' },
    ],
    L: [
      { q: 'David Lean\'s 1962 sweeping desert epic in which Peter O\'Toole plays the enigmatic British officer T. E. Lawrence.', a: 'Lawrence of Arabia', category: 'screen' },
      { q: 'Luc Besson\'s 1994 thriller in which a laconic hitman reluctantly protects a twelve-year-old girl after her family is murdered.', a: 'Leon the Professional', category: 'screen' },
    ],
    M: [
    ...
    O: [
      { q: 'Elia Kazan\'s 1954 classic in which Marlon Brando\'s Terry Malloy delivers the "I coulda been a contender" monologue.', a: 'On the Waterfront', category: 'screen' },
    ],
    P: [
    ...
    R: [
      ...
      { q: 'Alfonso Cuarón\'s 2018 monochrome personal film recreating his 1970s Mexico City childhood through the eyes of a domestic worker.', a: 'Roma', category: 'screen' },
      { q: 'Roberto Rossellini\'s 1945 Italian neorealist film about daily life under the German occupation of Rome, shot in the actual streets.', a: 'Rome Open City', category: 'screen' },
    ],
    S: [
    ...
    U: [
      { q: 'Clint Eastwood directed and starred in this 1992 deconstructionist Western about a retired outlaw\'s final job for a reward.', a: 'Unforgiven', category: 'screen' },
    ],
    V: [
      ...
      { q: 'Alfred Hitchcock\'s 1958 masterpiece in which a retired detective with acrophobia becomes obsessed with a mysterious blond woman.', a: 'Vertigo', category: 'screen' },
    ],
    W: [
    ...
    X: [
      { q: 'Bryan Singer\'s 2000 Marvel superhero film that introduced Hugh Jackman\'s Wolverine alongside Professor Xavier\'s team of mutants.', a: 'X-Men', category: 'screen' },
    ],
    Y: [
      { q: 'Taylor Sheridan created this Paramount Network ranching drama in which Kevin Costner plays patriarch John Dutton defending his land.', a: 'Yellowstone', category: 'screen' },
    ],
    Z: [
      ...
      { q: 'David Fincher\'s 2007 procedural about the real-life hunt for a serial killer who taunted police with coded messages in 1970s San Francisco.', a: 'Zodiac', category: 'screen' },
    ],
  },
};
