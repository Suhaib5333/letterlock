# 📜 Letterlock — Build History (rounds 1-32)

The round-by-round implementation log, moved out of `CLAUDE.md` on 2026-09-15 to keep that
file under its size limit. **Nothing was cut** — every round below is verbatim. The standing
rules distilled from these rounds live in `CLAUDE.md` ("Working rules" + "Working rules learned
the hard way"), which is the file to read first. The LATEST round always stays in `CLAUDE.md`.
...
# 📦 Moved out of `CLAUDE.md` on 2026-09-15 (verbatim)

`CLAUDE.md` was over its size budget. Nothing below was cut — it was moved here whole.
The standing rules distilled from it stay in `CLAUDE.md`; this is the detail behind them.
